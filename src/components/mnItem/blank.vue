                        ...
                        <el-form :model="mnItem" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                          <el-form-item label="记账日期" required prop="note_date">
                              <el-form-item prop="date1">
                                <el-date-picker type="date" placeholder="选择日期" v-model="mnItem.note_date" style="width: 100%;"></el-date-picker>
                              </el-form-item>
                          </el-form-item>
                          ...
                          <el-form-item>
                            <el-button type="primary" @click="saveItem('ruleForm')">立即创建</el-button>
